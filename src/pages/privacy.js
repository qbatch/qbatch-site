...
const Privacy = () => {
  ...
  const disclosure = [
    ...
    " To protect and defend the rights or property of Qbatch",
    " To prevent or investigate possible wrongdoing in connection with the Service",
    " To protect the personal safety of users of the Service or the public",
    "To protect against legal liability",
  ]
  const contact = [
    "By email: info@qbatch.com",
    "By visiting this page on our website: http://qbatch.com/privacy-policy/",
  ]
  return (
    <Layout>
        ...
        <Container className={`module-wrapper`}>
          ...
          <div className={`terms-text`}>
            ...
            <p>
              ...
              “our") operates the qbatch.com website (the “Service"). This page
            ...
            <div id={`transfer`}>
              ...
              <p>
                ...
                jurisdiction. If you are located outside Pakistan and choose to
                provide information to us, please note that we transfer the
                data, including Personal Data, to Pakistan and process it there.
                Your consent to this Privacy Policy followed by your submission
                of such information represents your agreement to that transfer.
                Qbatch will take all steps reasonably necessary to ensure that
